        ...
        <div className="max-w-5xl mx-auto mb-20">
          <div className="text-center mb-12">
            ...
            <p className="text-lg text-slate-600 max-w-2xl mx-auto">
              ...
              and entrepreneurs. Our Build and Renovate teams stay with you after the purchase.
            </p>
          </div>
          <div className="grid md:grid-cols-2 gap-8">
            <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Build: bring it online</h3>
              <p className="text-slate-600 leading-relaxed">
                From licensing and staffing to scheduling and patient communication, our Build team
                gets your newly acquired clinic operating smoothly under new ownership.
              </p>
            </div>
            <div className="bg-white rounded-3xl p-8 border border-slate-200 shadow-sm">
              <h3 className="text-2xl font-bold text-slate-900 mb-3">Renovate: make it profitable</h3>
              <p className="text-slate-600 leading-relaxed">
                Hands-on coaching for your operators across the four pillars of clinic performance:
